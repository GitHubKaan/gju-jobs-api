...
export function sendAuthMail(email: string, os: string | undefined, browser: string | undefined) {
    const content = `
        <!DOCTYPE html>
            ...
            <head>
                ...
                <title>VitalYou</title><!-- Made with Postcards Email Builder by Designmodo -->
                <style>
                    html,
                    body {
                        margin: 0 !important;
                                                                            ...
                                                                            <div class="pc-font-alt" style="text-decoration:none">
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                                        <span
                                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-weight:400;font-size:16px;line-height:180%">We
                                                                                            are writing to inform you that a
                                                                                            successful login to your GJU Jobs
                                                                                            account has just occurred.</span></div>
                                                                                    <div><br></div>
                                                                                    <div
                                                                                        style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                                        <span
                                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-weight:400;font-size:16px;line-height:180%">If
                                                                                            this was you, no further action is
                                                                                            required.</span></div>
                                                                                    <div><br></div>
                                                                                    ${os ? `<div
                                                                                        style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                                        <span
                                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-size:16px;line-height:180%;font-weight:400">OS:
                                                                                            ${os}</span></div>` : ``
                                                                                    }
                                                                                    ${browser ? `<div
                                                                                        style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                                        <span
                                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-size:16px;line-height:180%;font-weight:400">Browser:
                                                                                            ${browser}</span>
                                                                                        </div>` : ``
                                                                                    }
                                                                                    <div
                                                                                        style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                                        <span
                                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-size:16px;line-height:180%;font-weight:400">Time:
                                                                                            ${getCurrentTimestamp()}</span></div>
                                                                                    <div><br></div>
                                                                                    <div
                                                                                        style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                                        <span
                                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-weight:400;font-size:16px;line-height:180%">If
                                                                                            you do not recognize this login, please
                                                                                            secure your account immediately by using
                                                                                            the account recovery option to reset
                                                                                            your access credentials. If you need
    ...
    `;
    sendEmail(EMailSender.NoReply, email, "Successful Login to GJU Jobs Platform", content);
};