...
export function sendCustomerServiceSupportMail(payload: Support, caseNumber: string) {
    ...
    sendEmail(EMailSender.System, ENV.SUPPORT_EMAIL, `${caseNumber} ${payload.email} Support Request`, content);
};
...
<body class="body pc-font-alt"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                is a confirmation email to inform you
                                                                                that we successfully
                                                                                received your support request with the Case-number: ${caseNumber} on the ${getCurrentTimestamp()}. No further action is
                                                                                required.</span></div>
                                                                        <div><br></div>
                                                                        <div
                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                            <span
                                                                                ...
                                                                                you do not recognize this request,
                                                                                please ignore this email and delete it.
    ...
    sendEmail(EMailSender.NoReply, email, "We received your Support request", content);
};