 ...
 * @param companyEmail Reciving E-Mail-Address
 * @param studentEmail
...
<head>
    ...
    <style>
        ...
        @font-face {
            ...
            font-style: normal;
            font-weight: 700;
            src: url('https://fonts.gstatic.com/l/font?kit=iJWZBXyIfDnIV5PNhY1KTN7Z-Yh-4I-FWUUz&skey=cee854e66788286d&v=v31') format('woff'), url('https://fonts.gstatic.com/s/rubik/v31/iJWZBXyIfDnIV5PNhY1KTN7Z-Yh-4I-FWUU1.woff2') format('woff2');
        }
    </style>
...
<body class="body pc-font-alt"
                                        ...
                                        <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr>
                                                <td valign="top" class="pc-w620-padding-10-20-10-20"
                                                    style="padding:10px 40px 0;height:unset;background-color:transparent"
                                                    bgcolor="transparent">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                received an application from a Student
                                                                                using the GJU Jobs Portal.</span></div>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <div class="pc-font-alt" style="text-decoration:none">
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                            <span
                                                                                style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-weight:700;font-size:16px;line-height:180%">Personal
                                                                                Information:</span></div>
                                                                        <div
                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                            <span
                                                                                style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-weight:400;font-size:16px;line-height:180%">Name:
                                                                                ${studentGivenName} ${studentSurname}</span></div>
                                                                        <div
                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                            <span
                                                                                style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-weight:400;font-size:16px;line-height:180%">Degree:
                                                                                ${studentDegree}</span></div>
                                                                        <div
                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                            <span
                                                                        ...
                                                                        ${message ? `<div
                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                            <span
                                                                                style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-weight:700;font-size:16px;line-height:180%">Message:</span>
                                                                        </div>` : ""}
                                                                        ${message ? `<div style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                            <span
                                                                                style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-weight:400;font-size:16px;line-height:180%">${message}</span>
                                                                        </div>` : ""}
                                                                        <div><br></div>
                                                                        ${(studentEmail || studentPhone) ? `<div
                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                            <span
                                                                                style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-weight:700;font-size:16px;line-height:180%">Contact
                                                                                Details:</span></div>
                                                                        <div` : ""}
                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                            <span
                                                                                style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-weight:400;font-size:16px;line-height:180%">Email:
                                                                                ${studentEmail}</span></div>
                                                                        ${studentPhone ? `<div
                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                            <span
                                                                                style="font-family:'Rubik',Arial,Helvetica,sans-serif;font-weight:400;font-size:16px;line-height:180%">Phone:
                                                                                ${studentPhone}</span></div>` : ""}
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                contact our support team.</span></div>
                                                                        <div><br></div>
                                                                        <div
                                                                            style="font-family:'Rubik',Arial,Helvetica,sans-serif">
                                                                            <span
                                        ...
                                        <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0"
                                            ...
                                            <tr>
                                                <td valign="top" class="pc-w620-padding-40-30-30-30"
                                                    style="padding:20px 40px 40px;height:unset;background-color:transparent"
                                                    bgcolor="transparent">
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                        role="presentation">
                                                        <tr>
    ...
    `;
    sendEmail(EMailSender.NoReply, companyEmail, "New application received", content);
};