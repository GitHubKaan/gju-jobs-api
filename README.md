...
| POST   | Login             | /user/login          |                      | email: string                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |        | Authentication Token | expires: string<br>authCode: string                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| GET    | Get Recovery Link | /user/recovery       |                      | email: string                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |        |                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| GET    | Retrieve          | /jobs        |                     |                                                                                                                                                                                                                | tags: number[]<br>sort: string<br>page: number<br>pageSize: number |                  | companyInfo: {<br>    email: string<br>    phone: string<br>    company: string<br>    description: string<br>    givenName: string<br>    surname: string<br>    size: string<br>    industry: string<br>    country: string<br>}<br>jobs: {<br>    uuid: string<br>    title: string<br>    description: string<br>    location: string<br>    tags: number[]<br>    position: string<br>    exp: string \| undefined<br>    created: string<br>}[] |
