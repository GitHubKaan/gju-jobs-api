...
| GET    | Retrieve          | /jobs        |                     |                                                                                                                                                                                              | tags: number[] sort: string page: number pageSize: number |                  | totalJobs: number, jobs: {     uuid: string     title: string     description: string     location: string     tags: number[]     position: string     exp: string \| undefined     created: string companyInfo: {     email: string     phone: string     company: string     description: string     givenName: string     surname: string     size: string     industry: string     country: string } }[] |
